...
<br/>
	...
	We rely on Donations to keep the servers running. If you like playing on our servers please help keep them running by donating at www.clanvalhalla.com.au just $5 per month can reserve you a slot on the server, so you can always play...no waiting.<br/><br/> 
	Server Version: v10.1<br/>
	Mod Keys Server Side for @cba @stmovement @JSRS @blastcore<br/>
	Build Date: 07/12/2012 12:50:00
"
]
];
